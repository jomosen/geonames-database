...
class CountryInputMapper:
    ...
    def from_api(data: dict) -> Country:
        ...
        return Country(
            ...
            area_in_sq_km=to_float(data.get("areaInSqKm")),
            population=to_int(data.get("population")),
            continent_code=data.get("continent"),
            continent_name=data.get("continentName"),
            languages=data.get("languages"),
            currency_code=data.get("currencyCode"),
            postal_code_format=data.get("postalCodeFormat"),
            north=to_float(data.get("north")),
            south=to_float(data.get("south")),
            east=to_float(data.get("east")),
            west=to_float(data.get("west")),
        )