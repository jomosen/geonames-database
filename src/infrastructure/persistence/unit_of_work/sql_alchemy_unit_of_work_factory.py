...
from src.infrastructure.persistence.repositories.sql_alchemy_geoname_alternatename_repository import SqlAlchemyGeoNameAlternateNameRepository
...
class SqlAlchemyUnitOfWorkFactory(AbstractUnitOfWorkFactory):
    ...
    def __call__(self) -> SqlAlchemyUnitOfWork:
        return SqlAlchemyUnitOfWork(
            ...
            geoname_alternatename_repo_cls=SqlAlchemyGeoNameAlternateNameRepository,
